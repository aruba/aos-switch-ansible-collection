...
options:
  command:
    description: Function name calls according to configuration required.
      ...
      config_authentication_console - Configure authentication mechanism
                                      used to control access to the
                                      switch console.
      config_authentication_ssh - Configure authentication mechanism used to
                                  control SSH access to the switch.
...
def config_authentication_console(module):
    ...
    data = {}
    data['auth_console_login'] = {'primary_method':
                                  params['primary_method'],
                                  'secondary_method':
                                  params['secondary_method']}
...
def config_authentication_ssh(module):
    ...
    data = {}
    data['auth_ssh_login'] = {'primary_method': params['primary_method'],
                              'secondary_method': params['secondary_method']}
