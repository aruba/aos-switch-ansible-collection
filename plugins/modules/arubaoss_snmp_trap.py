...
options:
    ...
    mac_notify_trap_interval:
        description:
            - Trap interval (0 - 120) for mac_move_notify_mode and mac_notify_mode
        required: false
        default: 30
        type: int
    running_config_trap_interval:
        description:
            - Traps interval (0 - 120) for running_conf_change_trap
        required: false
        default: 0
        type: int
    ...
    module_args = dict(
        ...
        snmp_authentication=dict(type='str', required=False,
                                 ...
                                 choices=['SATM_EXTENDED',
                                          'SATM_STANDARD',
                                          'SATM_NONE']),
        mac_notify_trap_interval=dict(type='int', required=False, default=30),
