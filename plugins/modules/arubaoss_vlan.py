...
def config_vlan_ipaddress(module):
    ...
    if params['ip_address_mode'] == "IAAM_STATIC" and \
        ...
        if params['version'] == "" or params['vlan_ip_address'] == "":
            ...
            data['ip_address'] = {'version': params['version'],
        ...
        if params['version'] == "" or params['vlan_ip_mask'] == "":
            ...
            data['ip_mask'] = {'version': params['version'],
...
def config_vlan_dhcpHelperAddress(module):
    ...
    if params['helper_addresses'] == "":
        ...
        data['dhcp_helper_address'] = {'version': params['version'],
    ...
    check_presence = get_config(module, "/vlans/" + str(params['vlan_id']))
    if not check_presence:
        return {'msg': 'Cannot configure Helper Address without '
                'Vlan configured', 'changed': False, 'failed': True}
...
def config_vlan(module):
    ...
    if (firmware[:2] == "YA") or (firmware[:2] == "YB"):
        if params['is_dhcp_server_enabled']:
            return {'msg': "option : is_dhcp_server_enabled is not "
...
def run_module():
    module_args = dict(
        ...
        is_dhcp_server_enabled=dict(type='bool', required=False,
                                    default=False),
